...
public class ItemStaticDataManager
{
    ...
    public Dictionary<int, Item_DataTable> dicNaturalResource_DataTables;
    ...
    public void LoadItemDatas()
    {
        ...
        var arrNaturalResource_DataTables = JsonConvert.DeserializeObject<Item_DataTable[]>(Item_DataTable);
        ...
        this.dicNaturalResource_DataTables = arrNaturalResource_DataTables.ToDictionary(x => x.ItemData_Index);
