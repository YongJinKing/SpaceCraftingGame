...
public class BuildingUIStructure
{
    ...
    public Dictionary<int, CraftBuildingInfoTable> dicBUIInfoTable;
    ...
    public void LoadBuildingInfo()
    {
        ...
        var Pexplorer_CBCInfoTable = Resources.Load<TextAsset>("Component/Building/Pexplorer_Building_InformationTable").text;
        ...
        var arrCBInfoDatas = JsonConvert.DeserializeObject<CraftBuildingInfoTable[]>(Pexplorer_CBCInfoTable);
        ...
        this.dicBUIInfoTable = arrCBInfoDatas.ToDictionary(x => x.BuildingInformation_Index);
    }
}
